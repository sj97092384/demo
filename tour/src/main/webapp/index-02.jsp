			...
			<div class="flexslider-hero-slider">
				<div id="mainFlexSlider">
					<div class="flexslider">
						<ul class="slides">
							<li class="slide">
								<div class="flexslider-image-bg"
									style="background: url(images/hero-header/02.jpg) center center no-repeat; background-size: cover"></div>
							</li>
							<!-- slide1 end -->

							<li class="slide">
								<div class="flexslider-image-bg"
									style="background: url(images/hero-header/03.jpg) center center no-repeat; background-size: cover"></div>
							</li>
							<!-- slide2 end -->

							<li class="slide">
								<div class="flexslider-image-bg"
									style="background: url(images/hero-header/04.jpg) center center no-repeat; background-size: cover"></div>
							</li>
							<!-- slide3 end -->

							<li class="slide">
								<div class="flexslider-image-bg"
									style="background: url(images/hero-header/05.jpg) center center no-repeat; background-size: cover"></div>
							</li>
							<!-- slide4 end -->

							<li class="slide">
								<div class="flexslider-image-bg"
									style="background: url(images/hero-header/06.jpg) center center no-repeat; background-size: cover"></div>
							</li>
							<!-- slide5 end -->
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
								...
								<p class="lead">Visit Europe, America, Asia, Africa or
									beyond!</p>
								...
								<div class="column-item">
									...
									<div class="form-group">
										...
										<select name="destination" class="select2-multi form-control"
											data-placeholder="Choose a Destination" multiple>
								...
								<div class="column-item">
									...
									<div class="form-group">
										...
										<select name="year" class="select2-multi form-control"
											data-placeholder="Choose a Departure Year" multiple>
				...
				<div class="container">
					...
					<div class="grid destination-grid-wrapper">
						...
						<div class="grid-item" data-colspan="10" data-rowspan="10">
							<a href="result-grid.jsp" class="top-destination-image-bg"
								style="background-image: url('images/destination-grid/01.jpg');">
								<div class="relative">
									<h4>Turkey</h4>
						...
						<div class="grid-item" data-colspan="10" data-rowspan="4">
							<a href="result-grid.jsp" class="top-destination-image-bg"
								style="background-image: url('images/destination-grid/02.jpg');">
								<div class="relative">
									<h4>Croatia</h4>
									<span>Starting from $322</span>
								</div>
						...
						<div class="grid-item" data-colspan="5" data-rowspan="6">
							<a href="result-grid.jsp" class="top-destination-image-bg"
								style="background-image: url('images/destination-grid/03.jpg');">
								<div class="relative">
									<h4>USA</h4>
									<span>Starting from $322</span>
								</div>
						...
						<div class="grid-item" data-colspan="5" data-rowspan="6">
							<a href="result-grid.jsp" class="top-destination-image-bg"
								style="background-image: url('images/destination-grid/04.jpg');">
								<div class="relative">
									<h4>Emirates</h4>
									<span>Starting from $322</span>
								</div>
					...
					<div class="row">
						...
						<div class="col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
							...
							<div class="section-title">
								...
								<p>Of distrusts immediate enjoyment curiosity do. Marianne
									numerous saw thoughts the humoured.</p>
										...
										<div class="content clearfix">
											...
											<div class="rating-wrapper">
												<div class="raty-wrapper">
													<div class="star-rating-read-only" data-rating-score="4.0"></div>
													<span> / 7 review</span>
												</div>
											</div>
								...
								<div class="package-grid-item">
									<a href="detail-page.jsp">
										...
										<div class="content clearfix">
											...
											<div class="rating-wrapper">
												<div class="raty-wrapper">
													<div class="star-rating-read-only" data-rating-score="3.5"></div>
													<span> / 7 review</span>
												</div>
											</div>
											<div class="absolute-in-content">
								...
								<div class="package-grid-item">
									<a href="detail-page.jsp">
										...
										<div class="content clearfix">
											...
											<div class="rating-wrapper">
												<div class="raty-wrapper">
													<div class="star-rating-read-only" data-rating-score="4.5"></div>
													<span> / 7 review</span>
												</div>
											</div>
											<div class="absolute-in-content">
								...
								<div class="package-grid-item">
									<a href="detail-page.jsp">
										...
										<div class="content clearfix">
											...
											<div class="rating-wrapper">
												<div class="raty-wrapper">
													<div class="star-rating-read-only" data-rating-score="5.0"></div>
													<span> / 7 review</span>
												</div>
											</div>
											<div class="absolute-in-content">
			...
			<section class="overflow-hidden why-us-half-image-wrapper">
				...
				<div class="GridLex-grid-noGutter-equalHeight">
						...
						<div class="why-us-half-image-content">
							...
							<div class="featured-item">
								...
								<div class="content clearfix">
									...
									<p>Blind would equal while oh mr lain led and fact none.
										One preferred sportsmen resolving the happiness continued.
										High at of in loud rich true.</p>
							...
							<div class="featured-item">
								...
								<div class="content clearfix">
									...
									<p>Admiration stimulated cultivated reasonable be
										projection possession of. Real no near room ye bred sake if
										some. Is arranging furnished knowledge.</p>
							...
							<div class="featured-item">
								...
								<div class="content clearfix">
									...
									<p>Effect twenty indeed beyond for not had county. The use
										him without greatly can private. Increasing it unpleasant no
										of contrasted no continuing.</p>
					...
					<div class="GridLex-col-6_sm-12 image-bg">
						<div class="image-bg"
							style="background-image: url('images/image-01.jpg');"></div>
					</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-6">
								<div class="testimonial-item clearfix">
									...
									<div class="content">
										<h4>Antony Robert</h4>
										<h6>From Spain</h6>
										<p>She meant new their sex could defer child. An lose at
											quit to life do dull. Moreover end horrible endeavor entrance
											any families. Income appear extent on of thrown in admire.</p>
									</div>
								</div>
							</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-6">
								<div class="testimonial-item clearfix">
									...
									<div class="content">
										...
										<h6>From Turkey</h6>
										<p>Consider now provided laughter boy landlord dashwood.
											Often voice and the spoke. No shewing fertile village equally
											prepare up females sentiments increasing particular.</p>
									</div>
								</div>
							</div>
						...
						<div class="flex-column flex-sm-12">
							<div class="newsletter-text clearfix">
								...
								<div class="content">
									...
									<p>Affronting everything discretion men now own did. Still
									...
									<div class="input-group">
										<input type="text" class="form-control"
											...
											<button class="btn btn-primary" type="button">
												Signup <i class="fa fa-long-arrow-right"></i>
											</button>
										</span>
									</div>
								</form>
